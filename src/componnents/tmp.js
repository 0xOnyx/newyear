...
*/
        let numberStage
		let numberStageCtx
	    let numberStageWidth = 680
		let numberStageHeight = 420
		let numberOffsetX
		let numberOffsetY
		...
		let countdownTimer = 2800
		let countdownRunning = true
		
		let number
		let dots = []
		let numberPixelCoordinates
		let circleRadius = 2
		let colors = ['61, 207, 236', '255, 244, 174', '255, 211, 218', '151, 211, 226']
